...
class EthicalHackingToolkit:
    ...
    def print_banner(self):
        ...
        banner = pyfiglet.figlet_format("ETHICAL HACKER", font="slant")
        print(f"{Fore.RED}{banner}")
        print(f"{Fore.YELLOW}╔══════════════════════════════════════════════════════════╗")
        print(f"{Fore.YELLOW}║     Ultimate Ethical Hacking Toolkit v{self.version}          ║")
        print(f"{Fore.YELLOW}║        50+ Tools - For Educational Use Only            ║")
